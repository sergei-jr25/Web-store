(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".collection__slider")) new core(".collection__slider", {
            ...
            speed: 800,
            pagination: {
                el: ".collection__dotts",
                clickable: true
            },
            navigation: {
                prevEl: ".collection__arrow_prev",
                nextEl: ".collection__arrow_next"
            },
            on: {}
        });
        if (document.querySelector(".products-catalog__slider")) new core(".products-catalog__slider", {
            ...
            speed: 800,
            pagination: {
                el: ".products-catalog__dotts",
                clickable: true
            },
            navigation: {
                prevEl: ".products-catalog__arrow_prev",
                nextEl: ".products-catalog__arrow_next"
            },
            on: {}
        });
    }
    ...
    window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
        ...
        var t = {
            ...
            var n;
            return "easeInQuad" === e.easing && (n = t * t), "easeOutQuad" === e.easing && (n = t * (2 - t)), 
            "easeInOutQuad" === e.easing && (n = t < .5 ? 2 * t * t : (4 - 2 * t) * t - 1), 
            "easeInCubic" === e.easing && (n = t * t * t), "easeOutCubic" === e.easing && (n = --t * t * t + 1), 
            "easeInOutCubic" === e.easing && (n = t < .5 ? 4 * t * t * t : (t - 1) * (2 * t - 2) * (2 * t - 2) + 1), 
            "easeInQuart" === e.easing && (n = t * t * t * t), "easeOutQuart" === e.easing && (n = 1 - --t * t * t * t), 
            "easeInOutQuart" === e.easing && (n = t < .5 ? 8 * t * t * t * t : 1 - 8 * --t * t * t * t), 
            "easeInQuint" === e.easing && (n = t * t * t * t * t), "easeOutQuint" === e.easing && (n = 1 + --t * t * t * t * t), 
            "easeInOutQuint" === e.easing && (n = t < .5 ? 16 * t * t * t * t * t : 1 + 16 * --t * t * t * t * t), 
            e.customEasing && (n = e.customEasing(t)), n || t;
        }, s = function() {
            ...
            return r = Math.max(r - n - o, 0), i && (r = Math.min(r, s() - e.innerHeight)), 
            r;
        }, m = function(e) {
            ...
            0 === t && document.body.focus(), o || (t.focus(), document.activeElement !== t && (t.setAttribute("tabindex", "-1"), 
            t.focus(), t.style.outline = "none"), e.scrollTo(0, n));
        }, g = function(t, n, o, i) {
        ...
        return function(r, v) {
            ...
            C.cancelScroll = function(e) {
                ...
                var a = o(y || t, r || {}), u = "[object Number]" === Object.prototype.toString.call(n), f = u || !n.tagName ? null : n;
                if (u || f) {
                    var v = e.pageYOffset;
                    a.header && !S && (S = document.querySelector(a.header)), b || (b = m(S));
                    var w, E, A, I = u ? n : l(f, b, parseInt("function" == typeof a.offset ? a.offset(n, i) : a.offset, 10), a.clip), q = I - v, M = s(), F = 0, L = d(q, a), x = function(t, o) {
                        var r = e.pageYOffset;
                        if (t == o || r == o || (v < o && e.innerHeight + r) >= M) return C.cancelScroll(!0), 
                        p(n, o, u), g("scrollStop", a, n, i), w = null, O = null, !0;
                    }, H = function(t) {
                        w || (w = t), F += t - w, E = F / parseInt(L, 10), E = E > 1 ? 1 : E, A = v + q * c(a, E), 
                        e.scrollTo(0, Math.floor(A)), x(A, I) || (O = e.requestAnimationFrame(H), w = t);
                    };
                    0 === e.pageYOffset && e.scrollTo(0, 0), h(n, u, a), g("scrollStart", a, n, i), 
                    C.cancelScroll(!0), e.requestAnimationFrame(H);
                }
            };
            var I = function(t) {
                if (!i() && 0 === t.button && !t.metaKey && !t.ctrlKey && "closest" in t.target && (E = t.target.closest(r)) && "a" === E.tagName.toLowerCase() && !t.target.closest(y.ignore) && E.hostname === e.location.hostname && E.pathname === e.location.pathname && /#/.test(E.href)) {
                    var n = u(a(E.hash)), o = y.topOnEmptyHash && "#" === n ? document.documentElement : document.querySelector(n);
                    o = o || "#top" !== n ? o : document.documentElement, o && (t.preventDefault(), 
                    f(y), C.animateScroll(o, E));
                }
            }, q = function(e) {
            ...
            return C.destroy = function() {
                y && (document.removeEventListener("click", I, !1), e.removeEventListener("resize", M, !1), 
                e.removeEventListener("popstate", q, !1), C.cancelScroll(), y = null, null, E = null, 
                S = null, b = null, A = null, O = null);
            }, C.init = function(i) {
                if (!n()) throw "Smooth Scroll: This browser does not support the required JavaScript methods and browser APIs.";
                C.destroy(), y = o(t, i || {}), S = y.header ? document.querySelector(y.header) : null, 
                b = m(S), document.addEventListener("click", I, !1), S && e.addEventListener("resize", M, !1), 
                y.updateURL && y.popstate && e.addEventListener("popstate", q, !1);
            }, C.init(v), C;
        };
    }));
    new SmoothScroll(".collection__scroll");
    document.addEventListener("click", (e => {
        const target = e.target;
        if (target.closest(".search-header__button")) document.querySelector(".search-header").classList.toggle("_active"); else if (!target.closest(".search-header__button") && !target.closest(".search-header")) document.querySelector(".search-header").classList.remove("_active");
        if (target.closest(".sizes__size")) {
            const sizeActive = document.querySelector(".sizes__size._active");
            if (sizeActive) sizeActive.classList.remove("_active");
            target.closest(".sizes__size").classList.add("_active");
        }
    }));
    window["FLS"] = true;
    isWebp();
